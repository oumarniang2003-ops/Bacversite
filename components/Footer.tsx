      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <Link href="/" className="flex items-center space-x-2">
              <div className="w-8 h-8 rounded-lg bg-gradient-to-tr from-blue-600 to-indigo-500 flex items-center justify-center text-white font-bold text-sm">
                B
              </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              <li>
                <Link href="/ecoles" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                  Universités & Écoles
                </Link>
              </li>
              <li>
                <Link href="/concours" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                  Concours d'entrée
                </Link>
              </li>
              <li>
                <Link href="/bourses" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                  Bourses d'études
                </Link>
              </li>
              <li>
                <Link href="/etranger" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              ...
              <li>
                <Link href="/filieres" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-500 dark:text-gray-400">
              <li>
                Email: <a href="mailto:support@bacversite.sn" className="text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">support@bacversite.sn</a>
              </li>
              <li>
                Lieu: Dakar, Sénégal
              </li>
            ...
            <div className="flex space-x-4 mt-4">
              <a href="#" className="p-2 rounded-lg bg-gray-100 hover:bg-blue-50 dark:bg-gray-900 dark:hover:bg-gray-800 text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-all">
        ...
        <div className="mt-12 pt-8 border-t border-gray-200 dark:border-gray-800 flex flex-col sm:flex-row items-center justify-between text-xs text-gray-400">
          ...
          <div className="flex space-x-6 mt-4 sm:mt-0">
            <Link href="/mentions-legales" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
              Mentions Légales
            </Link>
            <Link href="/confidentialite" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
              Confidentialité
            </Link>
          </div>
        </div>
