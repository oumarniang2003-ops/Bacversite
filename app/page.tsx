    ...
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <section className="bg-white border-b border-gray-200 py-16 sm:py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
          ...
          <div className="inline-flex items-center px-3 py-1 rounded-full bg-emerald-50 border border-emerald-100 text-xs sm:text-sm font-semibold text-emerald-700">
          ...
          {/* Quick Search Form */}
          <form action="/ecoles" method="GET" className="max-w-2xl mx-auto flex items-center bg-gray-50 p-1.5 rounded-xl border border-gray-200 shadow-sm">
            <div className="relative flex-grow">
              ...
              <input
                ...
                className="w-full bg-transparent pl-10 pr-4 py-2.5 text-sm focus:outline-none text-gray-900"
              />
            </div>
            <button
              type="submit"
              className="bg-emerald-600 hover:bg-emerald-700 text-white text-sm font-bold px-5 py-2.5 rounded-lg transition-colors cursor-pointer"
            >
              Rechercher
            </button>
          </form>
      ...
      <section className="py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <Link href="/ecoles" className="p-6 rounded-xl bg-white border border-gray-200 shadow-sm hover:border-emerald-500/30 transition-colors">
              <div className="w-10 h-10 rounded-lg bg-emerald-50 text-emerald-600 flex items-center justify-center mb-4">
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" /></svg>
              </div>
              <h3 className="font-bold text-gray-900 mb-1">Annuaire des Écoles</h3>
              <p className="text-xs text-gray-500">Explorez les filières et les conditions d'admission.</p>
            </Link>

            <Link href="/concours" className="p-6 rounded-xl bg-white border border-gray-200 shadow-sm hover:border-emerald-500/30 transition-colors">
              <div className="w-10 h-10 rounded-lg bg-emerald-50 text-emerald-600 flex items-center justify-center mb-4">
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" /></svg>
              </div>
              <h3 className="font-bold text-gray-900 mb-1">Concours d'Entrée</h3>
              <p className="text-xs text-gray-500">Préparez vos candidatures aux concours nationaux.</p>
            </Link>

            <Link href="/bourses" className="p-6 rounded-xl bg-white border border-gray-200 shadow-sm hover:border-emerald-500/30 transition-colors">
              <div className="w-10 h-10 rounded-lg bg-emerald-50 text-emerald-600 flex items-center justify-center mb-4">
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
              </div>
              <h3 className="font-bold text-gray-900 mb-1">Bourses d'Études</h3>
              <p className="text-xs text-gray-500">Consultez les offres de bourses d'études disponibles.</p>
            </Link>

            <Link href="/etranger" className="p-6 rounded-xl bg-white border border-gray-200 shadow-sm hover:border-emerald-500/30 transition-colors">
              <div className="w-10 h-10 rounded-lg bg-emerald-50 text-emerald-600 flex items-center justify-center mb-4">
              ...
              <h3 className="font-bold text-gray-900 mb-1">Études à l'étranger</h3>
      ...
      <section className="py-12 bg-white border-t border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-8">
            ...
            <p className="text-xs text-gray-500">Opportunités de candidature arrivant à échéance sous 30 jours.</p>
          </div>

          {deadlines.length === 0 ? (
            <div className="bg-gray-50 border border-gray-200 p-8 text-center rounded-xl">
              ...
              {deadlines.map((item) => {
                ...
                return (
                  <div
                    ...
                    className="flex flex-col justify-between bg-white p-6 rounded-xl border border-gray-200 shadow-sm"
                  >
                    <div className="space-y-3">
                      ...
                      {item.item_type === "bourse" && (
                        <div className="flex gap-4 text-xs text-gray-500">
                          {item.pays && <span>📍 Pays : <span className="font-semibold text-gray-700">{item.pays}</span></span>}
                          {item.montant && <span>💰 Montant : <span className="font-semibold text-gray-700">{item.montant}</span></span>}
                        </div>
                      )}
                    </div>
