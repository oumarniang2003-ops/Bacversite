        ...
        {destinations.length === 0 ? (
          ...
          <div className="space-y-6">
            {destinations.map((dest) => (
              ...
              >
                {/* Header Banner */}
                <div className="bg-emerald-600 p-5 text-white flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                  ...
                  <div className="space-y-6">
                    {dest.procedures && (
                      <div className="space-y-2">
                        <h3 className="text-sm font-bold text-gray-900 uppercase tracking-wider border-l-4 border-emerald-600 pl-2">
                          Procédures d'admission
                        </h3>
                        <div className="text-sm text-gray-650 whitespace-pre-line leading-relaxed pl-2.5">
                          {dest.procedures}
                        </div>
                      </div>
                    )}
                  ...
                  <div className="space-y-5 bg-gray-50 p-5 rounded-lg border border-gray-200">
                    {dest.visa_info && (
                      <div className="space-y-3">
                        <h3 className="text-sm font-bold text-gray-900 uppercase tracking-wider flex items-center gap-1.5 border-b border-gray-150 pb-2">
