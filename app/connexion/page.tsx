    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center py-10 px-4">
      <div className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow-sm p-6 sm:p-8 space-y-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <div className="flex items-center justify-between mb-1">
              ...
              <Link href="/mot-de-passe-oublie" className="text-xs text-emerald-600 font-semibold hover:underline">
                Oublié ?
              </Link>
            </div>
            <input
        ...
        <p className="text-center text-xs text-gray-500">
          ...
          <Link href="/inscription" className="text-emerald-600 font-semibold hover:underline">
            S&apos;inscrire
          </Link>
        </p>
      </div>
